...
router.use(cors());
  ...
  router.get('/form_childcare/has/:userId/:Year', (req, res, next) => {
  ...
  router.get('/form_childcare/has/:userId', (req, res, next) => {
  ...
  router.post('/form_childcare/:userId', (req, res, next) => {
    if(req.params.userId && isInteger(req.params.userId) ){
  ...
  router.put('/form_childcare/:ChildCareID', (req, res, next) => {
  ...
  router.delete('/form_childcare/:formId/:userId', (req, res, next) => {
    conectionDB();
