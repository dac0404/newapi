...
router.use(cors());
  ...
  router.get('/form_1095a/has/:userId/:Year', (req, res, next) => {
    conectionDB();
    return formFunctions.getByUserNYear(req, res, next, table, connection);
    
  });

  router.get('/form_1095a/has/:userId', (req, res, next) => {
    conectionDB();
    return formFunctions.getByUser(req, res, next, table, connection);
    
  });

  router.post('/form_1095a/:userId', (req, res, next) => {
  ...
  router.put('/form_1095a/:form1095aID', (req, res, next) => {
  ...
  router.delete('/form_1095a/:formId/:userId', (req, res, next) => {
    conectionDB();
