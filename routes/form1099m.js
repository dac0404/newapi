...
router.use(cors());
  ...
  router.get('/form_1099m/has/:userId/:Year', (req, res, next) => {
    conectionDB();
    return formFunctions.getByUserNYear(req, res, next, table, connection);
    
  });

  router.get('/form_1099m/has/:userId', (req, res, next) => {
    conectionDB();
    return formFunctions.getByUser(req, res, next, table, connection);
    
  });

  router.post('/form_1099m/:userId', (req, res, next) => {
  ...
  router.put('/form_1099m/:form1099mID', (req, res, next) => {
  ...
  router.delete('/form_1099m/:formId/:userId', (req, res, next) => {
    conectionDB();
