...
router.use(cors());
  ...
  router.get('/form_1099r/has/:userId/:Year', (req, res, next) => {
    conectionDB();
    return formFunctions.getByUserNYear(req, res, next, table, connection);
    
  });

  router.get('/form_1099r/has/:userId', (req, res, next) => {
    conectionDB();
    return formFunctions.getByUser(req, res, next, table, connection);
    
  });

  router.post('/form_1099r/:userId', (req, res, next) => {
  ...
  router.put('/form_1099r/:form1099rID', (req, res, next) => {
  ...
  router.delete('/form_1099r/:formId/:userId', (req, res, next) => {
    conectionDB();
