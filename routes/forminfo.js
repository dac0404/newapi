...
var db_config = require('../routes/db_config');
  ...
  router.get('/forminfo/byname/:Name', (req, res, next) => {
  ...
  router.get('/forminfo/', (req, res, next) => {
  ...
  router.get('/forminfo/has/:FormId', (req, res, next) => {
  ...
  router.get('/forminfo/listforms/:UserId', (req, res, next) => {

    if(req.params.UserId && isInteger(req.params.UserId) ){
      
      var userid = req.params.UserId;

      var query = "SELECT d.UserId, d.FormInfoId, d.Status, i.NameForm, i.Description, i.Amount, Count(i.Amount) as Counts, SUM(i.Amount) as Total FROM " + detail + " AS d INNER JOIN " + table + " AS i ON d.FormInfoId = i.Id";
      query = query + "  INNER JOIN " + unemploy + " AS u ON u.Id = d.FormId  AND u.FormInfoId = d.FormInfoId";
      query = query + "  where d.UserId = ? AND d.Status = 0 GROUP BY d.UserId, d.FormInfoId, d.Status,i.NameForm, i.Description, i.Amount";
      query = query + " UNION ALL";
      query = query + " SELECT d.UserId, d.FormInfoId, d.Status, i.NameForm, i.Description, i.Amount, Count(i.Amount) as Counts, SUM(i.Amount) as Total FROM " + detail + " AS d INNER JOIN " + table + " AS i ON d.FormInfoId = i.Id";
      query = query + "  INNER JOIN " + childcare + " AS u ON u.Id = d.FormId  AND u.FormInfoId = d.FormInfoId";
      query = query + "  where d.UserId = " + userid + " AND d.Status = 0 GROUP BY d.UserId, d.FormInfoId, d.Status,i.NameForm, i.Description, i.Amount";
      query = query + " UNION ALL";
      query = query + " SELECT d.UserId, d.FormInfoId, d.Status, i.NameForm, i.Description, i.Amount, Count(i.Amount) as Counts, SUM(i.Amount) as Total FROM " + detail + " AS d INNER JOIN " + table + " AS i ON d.FormInfoId = i.Id";
  ...
  router.put('/forminfo/:FormInfoId', (req, res, next) => {
  ...
  router.put('/forminfo/payforms/:UserId', (req, res, next) => {
