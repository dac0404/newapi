...
router.use(cors());
  ...
  router.get('/form_scha/has/:userId/:Year', (req, res, next) => {
  ...
  router.get('/form_scha/has/:userId', (req, res, next) => {
  ...
  router.post('/form_scha/:userId', (req, res, next) => {
    if(req.params.userId && isInteger(req.params.userId) ){
  ...
  router.put('/form_scha/:SchaId', (req, res, next) => {
  ...
  router.delete('/form_scha/:formId/:userId', (req, res, next) => {
    conectionDB();
