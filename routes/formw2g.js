...
router.use(cors());
  ...
  router.get('/w2g/has/:userId/:Year', (req, res, next) => {
  ...
  router.get('/w2g/has/:userId', (req, res, next) => {
  ...
  router.post('/w2g/:userId', (req, res, next) => {
    if(req.params.userId && isInteger(req.params.userId) ){
  ...
  router.put('/w2g/:w2gId', (req, res, next) => {
  ...
  router.delete('/w2g/:formId/:userId', (req, res, next) => {
    conectionDB();
