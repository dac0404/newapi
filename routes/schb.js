...
router.use(cors());
  ...
  router.get('/form_schb/has/:userId/:Year', (req, res, next) => {
    conectionDB();
    return formFunctions.getByUserNYear(req, res, next, table, connection);
    
  });

  router.get('/form_schb/has/:userId', (req, res, next) => {
    conectionDB();
    return formFunctions.getByUser(req, res, next, table, connection);
    
  });

  router.post('/form_schb/:userId', (req, res, next) => {
  ...
  router.put('/form_schb/:SchbID', (req, res, next) => {
  ...
  router.delete('/form_schb/:formId/:userId', (req, res, next) => {
    conectionDB();
