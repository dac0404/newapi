...
router.use(cors());
  ...
  router.get('/form_schc/has/:userId/:Year', (req, res, next) => {
    conectionDB();
    return formFunctions.getByUserNYear(req, res, next, table, connection);
    
  });

  router.get('/form_schc/has/:userId', (req, res, next) => {
    conectionDB();
    return formFunctions.getByUser(req, res, next, table, connection);
    
  });

  router.post('/form_schc/:userId', (req, res, next) => {
  ...
  router.put('/form_schc/:SchCID', (req, res, next) => {
  ...
  router.delete('/schc/:formId/:userId', (req, res, next) => {
    conectionDB();
  ...
  function loadData(body){
    ...
    _sqlparams.push(body.ZipCode ? body.ZipCode : "" );
     ...
     _sqlparams.push(body.OthersIncome ? body.OthersIncome : 0 );
     _sqlparams.push(body.CarBusiness ? body.CarBusiness : 0 );
