...
router.use(cors());
  ...
  router.get('/form_studentloan/has/:userId/:Year', (req, res, next) => {
  ...
  router.get('/form_studentloan/getstudent/:userId', (req, res, next) => {
  ...
  router.get('/form_studentloan/has/:userId', (req, res, next) => {
  ...
  router.post('/form_studentloan/:userId', (req, res, next) => {
    if(req.params.userId && isInteger(req.params.userId) ){
  ...
  router.put('/form_studentloan/:StudentLoanID', (req, res, next) => {
  ...
  router.delete('/form_studentloan/:formId/:userId', (req, res, next) => {
    conectionDB();
