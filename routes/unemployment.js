...
router.use(cors());
  ...
  router.get('/unemployment/has/:userId/:Year', (req, res, next) => {
  ...
  router.get('/unemployment/has/:userId', (req, res, next) => {
  ...
  router.post('/unemployment/:userId', (req, res, next) => {
    if(req.params.userId && isInteger(req.params.userId) ){
  ...
  router.put('/unemployment/:unemploymentId', (req, res, next) => {
  ...
  router.delete('/unemployment/:formId/:userId', (req, res, next) => {
    conectionDB();
